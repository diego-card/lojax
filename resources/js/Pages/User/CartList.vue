        ...
        <section class="text-gray-600 body-font relative">
            <div class="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
                            ...
                            <tr v-for="product in products" :key="product.id"
                                ...
                                <td class="p-4">
                                    <img v-if="product.product_images.length > 0"
                                        ...
                                        class="w-16 md:w-32 max-w-full max-h-full" alt="Cart image">
                                    <img v-else
                                        src="https://propertywiselaunceston.com.au/wp-content/themes/property-wise/images/no-image@2x.png"
                                        class="w-16 md:w-32 max-w-full max-h-full" alt="No Image available">
                                </td>
                ...
                <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                    ...
                    <p class="leading-relaxed mb-5 text-gray-600">Total: ${{ total }}
                        axe</p>
                    ...
                    <form @submit.prevent="submit">
                        ...
                        <button v-else type="submit"
                            ...
                            new address to continue</button>
                    </form>

                    <p class="text-xs text-gray-500 mt-3">Continue shopping
                        artisan.</p>
                </div>
            </div>
        </section>
