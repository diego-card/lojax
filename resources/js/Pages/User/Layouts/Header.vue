...
<template>
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">lojax</span>
            </Link>
                ...
                <div v-if="auth.user" class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600"
                    ...
                    <ul class="py-2" aria-labelledby="user-menu-button">
                        ...
                        <li v-if="auth.user.isAdmin">
                            <Link :href="route('admin.dashboard')" href="#"
                                class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Admin Dashboard</Link>
                        </li>
                        <li>
