...
//open add modal. PS: this is from the package, "element-plus". Check out it's site for more information: http://element-plus.org/en-US/
const openAddModal = () => {
...
<template>
    <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
        ...
        <el-dialog v-model="dialogVisible" :title="editMode ? 'Edit product' : 'Add Product'" width="35%"
            ...
            <form class="max-w-md mx-auto" @submit.prevent="editMode ? updateProduct() : AddProduct()">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input v-model="quantity" type="number" name="repeat_quantity" id="floating_quantity"
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder=" " required />
                ...
                <div>
                    <label for="category-select" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select
                        a category</label>
                    <select id="category-select" v-model="category_id"
                ...
                <div>
                    <label for="brand-select" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select a
                        brand</label>
                    <select id="brand-select" v-model="brand_id"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <div class="flex flex-nowrap mb-8">
                    <div v-for="(pimage, index) in product_images" :key="pimage.id" class="relative w-32 h-32">
                        <img class="w-32 h-32 rounded" :src="`/${pimage.image}`" alt="">
                        <span
